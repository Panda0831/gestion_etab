...
export class ClubEvenementOrganisateurController {
  constructor(private readonly clubEvenementOrganisateurService: ClubEvenementOrganisateurService) {}

  @Post()
  create(@Body() createClubEvenementOrganisateurDto: CreateClubEvenementOrganisateurDto) {
    return this.clubEvenementOrganisateurService.create(createClubEvenementOrganisateurDto);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateClubEvenementOrganisateurDto: UpdateClubEvenementOrganisateurDto) {
    return this.clubEvenementOrganisateurService.update(+id, updateClubEvenementOrganisateurDto);
  }
