...
export class TransactionFinanciereController {
  constructor(private readonly transactionFinanciereService: TransactionFinanciereService) {}

  @Post()
  create(@Body() createTransactionFinanciereDto: CreateTransactionFinanciereDto) {
    return this.transactionFinanciereService.create(createTransactionFinanciereDto);
  }
